...
class AddPayerDialog extends StatefulWidget {
  const AddPayerDialog({Key? key}) : super(key: key);

  @override
  State<AddPayerDialog> createState() => _AddPayerDialogState();
}

class _AddPayerDialogState extends State<AddPayerDialog> {
